...
function Login() {
    ...
    const handleLogin = async (e)=>{
        e.preventDefault();
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post('/auth/login', {
                email,
                password
            });
            if (res.data.token) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0t~ywe3._.js.map