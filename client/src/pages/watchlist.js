...
export default function Watchlist() {
  ...
  return (
    /* PERUBAHAN: Mengubah bg-[#F7F3EF] menjadi bg-[#f2eae1] */
    <div className="max-w-[1440px] mx-auto px-4 md:px-8 py-12 min-h-screen bg-[#f2eae1] dark:bg-[#151515] transition-colors duration-300">
      ...
      {loading ? (
        ...
        /* PERUBAHAN: Menyesuaikan bg-white/50 agar lebih serasi dengan latar belakang krem baru */
        <div className="text-center py-20 bg-white/40 backdrop-blur-sm dark:bg-surface rounded-2xl border border-black/5 dark:border-white/5 shadow-sm">
